...
import egovframework.theimc.common.exception.EgovAopExceptionTransfer;
import egovframework.theimc.common.exception.EgovSampleExcepHndlr;
import egovframework.theimc.common.exception.EgovSampleOthersExcepHndlr;
...
public class EgovConfigAspect {
	...
	@Bean
	public DefaultExceptionHandleManager defaultExceptionHandleManager(AntPathMatcher antPathMatcher,
	...
	public DefaultExceptionHandleManager otherExceptionHandleManager(AntPathMatcher antPathMatcher,
			EgovSampleOthersExcepHndlr othersExcepHndlr) {
		DefaultExceptionHandleManager defaultExceptionHandleManager = new DefaultExceptionHandleManager();
		defaultExceptionHandleManager.setReqExpMatcher(antPathMatcher);
		defaultExceptionHandleManager.setPatterns(new String[] { "**service.impl.*" });
