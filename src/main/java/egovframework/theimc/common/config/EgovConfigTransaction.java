...
public class EgovConfigTransaction {
	...
	@Bean
	public Advisor txAdvisor(@Qualifier("transactionManager") DataSourceTransactionManager txManager) {
		AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
		pointcut.setExpression("execution(* egovframework.theimc..impl.*Impl.*(..))");
